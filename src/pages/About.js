...
import Jamar from "../assets/IMG_8602.jpg"
import Grid from "@mui/joy/Grid"
import Tomas from "../assets/IMG_3129.jpg"
import Mckenley from "../assets/IMG_3746.jpg"
import Garry from "../assets/IMG_123.jpg"
      ...
      >
        ...
        >
          <CardContent sx={{ alignItems: "center", textAlign: "center" }}>
            <Avatar src={Jamar} sx={{ "--Avatar-size": "7rem" }} />
            <Chip
              size="sm"
              variant="soft"
              color="primary"
            ...
            <Typography level="title-lg">Jamar Watson</Typography>
            <Typography level="body-sm" sx={{ maxWidth: "24ch" }}>
              Experienced Full Stack Web Developer with a background in data
        ...
        >
          <CardContent sx={{ alignItems: "center", textAlign: "center" }}>
            <Avatar src={Tomas} sx={{ "--Avatar-size": "7rem" }} />
            <Chip
              size="sm"
              variant="soft"
              color="primary"
            ...
            <Typography level="title-lg">Tomas Trevino</Typography>
            <Typography level="body-sm" sx={{ maxWidth: "24ch" }}>
              Full Stack Web Developer with a background in PLC ,and special
              hazards programming, looking to push my skills as a developer.
            </Typography>
            <Box
              sx={{
                display: "flex",
        ...
        >
          <CardContent sx={{ alignItems: "center", textAlign: "center" }}>
            <Avatar src={Mckenley} sx={{ "--Avatar-size": "7rem" }} />
            <Chip
              size="sm"
              variant="soft"
              color="primary"
        ...
        >
          <CardContent sx={{ alignItems: "center", textAlign: "center" }}>
            <Avatar src={Garry} sx={{ "--Avatar-size": "7rem" }} />
            <Chip
              size="sm"
              variant="soft"
              color="primary"
            ...
            <Typography level="body-sm" sx={{ maxWidth: "24ch" }}>
            Full-Stack Web Developer Passionate about Bridging Military Leadership with Tech Expertise
            </Typography>
            <Box
              sx={{
                display: "flex",
